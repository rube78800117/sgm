...
class CreateCounts extends Component
{
    ...
    public $unit;
    public $purchase_description = 'Relevamiento de materiales y repuestos 2024',
        $state_id = 1; //se inicializa 1 estado
    public $savem;
    ...
    public function storeOrder()
    {
        ...
        session()->forget('selectedArticles');
    ...
    public function clearSelectedArticles()
    {
    ...
    {
        $this->dispatchBrowserEvent('alerttoastr', ['type' => 'error', 'message' => 'El articulo ya esta en la lista!, Numero de registro: ' . $key + 1]);
    }

    public function alertErrorSave($errorMessage)
    {
        $this->dispatchBrowserEvent('alerttoastr', ['type' => 'error', 'message' => 'No se pudo guardar la lista por que hay campos importantes sin llenar, llene todos los campos porfavor!, ', $errorMessage]);
    }
