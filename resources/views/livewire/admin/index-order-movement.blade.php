                                            ...
                                            <div class=" sm:text-xs text-xs">
                                                ...
                                                @switch($order->status)
                                                    @case(2)
                                                        ...
                                                        <div class="form-control rounded-lg p-2 bg-yellow-50 text-center  ">
                                                    ...
                                                    @case(3)
                                                        ...
                                                        <div class="form-control rounded-lg p-2 bg-blue-50  text-center  ">
                                                    ...
                                                    @case(4)
                                                        <br>
                                                        <div
                                                            class="form-control rounded-lg p-2 text-xs bg-green-100 text-center  ">
                                                    ...
                                                    @case(5)
                                                        <br>
                                                        <div
                                                            class=" form-control border-0 rounded-lg p-2 text-xs bg-green-100 dark:bg-black text-center  ">
                                                            <i
                                                    ...
                                                    @case(6)
                                                        ...
                                                        <div class=" form-control text-xs rounded-lg p-2 bg-red-100 text-center  ">
