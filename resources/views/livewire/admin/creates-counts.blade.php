<div>
    ...
    <div class="container mx-auto">
        ...
        <div class="grid sm:grid-cols-12 mb-1 gap-4 grid-cols-4">
            {{-- nivel 1 --}}
            <div class="col-span-2 sm:col-span-5 md:col-span-5  mt-4 bg-white rounded-xl shadow-xl">
                ...
                <div class="px-2 py-4  sm:p-2 ">
                    ...
                    <div class="relative mt-4 mb-2" x-data="{ isVisible: false, open: true}"
                ...
                <div class=" col-span-5 row-span-1  gap-4">
                            ...
                            <div class=" grid grid-cols-3  px-2 py-8  sm:p-6 gap-4 ">
                                ...
                                <div class=" form-group col-span-3">
                                    ...
                                    <input wire:model.defer="purchase_description" type="text"
                                        ...
                                        class="form-control rounded-md shadow-sm border-gray-300 focus:border-green-300 focus:ring focus:ring-green-200 focus:ring-opacity-50 w-full  sm:text-sm ">
            ...
            <div class="col-span-2 sm:col-span-7 md:col-span-7  mt-4 bg-white rounded-xl shadow-xl">

                <div class="grid grid-cols-2 sm:grid-cols-4 mb-1 gap-4">

                    <span class="hidden sm:block py-8">Datos documentacion: </span>
                    ...
                    <div class="form-group ">
                        ...
                        <input wire:model.defer="cod_document" type="text" name="cod_document"
                            ...
                            class="form-control rounded-md shadow-sm border-gray-300 focus:border-green-300 focus:ring focus:ring-green-200 focus:ring-opacity-50 w-full mb-1 mt-1 sm:text-sm ">
                    ...
                    <span class="hidden sm:block">Datos del almacen (Ubicación):</span>
            ...
            <div class="">
                                ...
                                <td class="px-5 py-1 border-b border-gray-200 bg-white text-sm">
                                    ...
                                    <ul class="flex">
                                        <li class=" text-gray-800 mr-2"><i class="text-blue-500 mr-2 fas fa-key"> </i>
                                            Dopp:</li>
                                        <li class=" text-gray-900 font-bold  ">{{$itemAdd['article_id_dopp'] }}</li>
                                    </ul>
                                    @endif
                                    ...
                                    <ul class="flex">
                                        ...
                                        <li class=" text-gray-900 font-bold "> {{ $itemAdd['article_id_eetc'] }}</li>
                                    </ul>
                                    @endif
                                    ...
                                    <ul class="flex">
                                        <li class=" text-gray-800 mr-2"><i class="text-gray-400 mr-2 fas fa-key"></i>
                                            Zona:</li>
                                        <li class=" text-gray-900 font-bold ">{{$itemAdd['article_id_zona'] }}</li>
                                    </ul>
                                    @endif
                ...
                <div class="flex justify-items-stretch ">
                    <div>
                        ...
                        <x-jet-input class="w-full" wire:model.defer="quantity" type="text" placeholder="Cantidad">
                            </x-jet>
                            <x-jet-input-error for="quantity" />

                    </div>
                    <div class="col-span-12 md:col-span-2 mt-2 py-2">
                        <x-button-enlace color="blue" class="flex w-full justify-center items-center "
                            wire:click.prevent="addArticle2()">AGREGRAR ITEM (Temporal)
                ...
                <div class="col-span-12 md:col-span-5 mt-2 py-2">
        ...
        <div class="flex justify-end inline-block mr-2 mt-2">
