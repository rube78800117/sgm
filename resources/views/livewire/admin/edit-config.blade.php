        ...
        <x-slot name="form">
            <div class="col-span-6 sm:col-span-4">
                ...
                <div class="flex gap-6">
                    ...
                    <div>
                        <label for="">
                            <input {{ $estado->activ_register ? 'checked' : '' }} value='1' type="radio"
                                name='ppp' wire:change="assignValue({{ 1 }}, $event.target.value)">
                            Si
                        </label>

                        <label class="ml-4">
                            <input {{ $estado->activ_register ? '' : 'checked' }} value='0' type="radio"
                                name='ppp' wire:change="assignValue({{ 1 }}, $event.target.value)">
                            No
                        </label>
                    </div>
                    <div>
                        ...
                        <p class="text-gray-900 text-center ">
                            ...
                            @else
                                <span
                                    class="inline-flex  text-red-700 rounded-full h-6 px-3 justify-center items-center">
                ...
                <div class="form-group ">
                    ...
                    <div class="flex justify-between">
                        <x-button-enlace 
                            wire:click="stockWarehouse()" color="blue" class="mt-4 mx-2"> Mostrar stock
                            actual de almacén seleccionado</x-button-enlace>
                    
                        <x-button-enlace 
                            wire:click="ordersWarehouse()" color="green" class="mt-4 mx-2"> Mostrar registros
                            de salidas de almacén seleccionado</x-button-enlace>
                        <x-button-enlace
                            wire:click="$emit('deleteWarehouseArticle')" color="red" class="mt-4 mx-2 ">Vaciar
                            almacén</x-button-enlace>

                    </div>

                </div>
                <x-jet-action-message on="deleted" class="mr-4">
            ...
            @else
                ...
                <table class="min-w-full leading-normal">
                    ...
                    <tbody>
                        @if ($dataOrders)
                            <!-- Iterar sobre cada elemento de la colección -->
                            @foreach ($dataOrders as $articleWarehouse)
                                <tr>
                                    ...
                                    <td class="px-5 py-1 border-b border-gray-200 bg-white text-sm">
                                        <p class="text-gray-900 whitespace-no-wrap">
                                            {{ $articleWarehouse->warehouse_name }}
                                            <!-- ?? ''   -->
                                        </p>
                                    </td>
