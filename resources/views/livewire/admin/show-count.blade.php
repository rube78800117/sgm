                                ...
                                <div class="d-flex justify-content-between">
                                    <div class="me-1">
                                        ...
                                        <div class="d-flex align-items-center">
                                            <h4 class="mb-2 me-1 display-6">{{ $countDetailsTotal->count() }}</h4>
                            ...
                            <div class="card-body">
                                <div class="d-flex justify-content-between">
                                    <div class="me-1">
                                        ...
                                        <div class="d-flex align-items-center">
                                            <h4 class="mb-2 me-1 display-6">{{ $countDetailsFound->count() }}</h4>
                                            <p class="text-success mb-2">
                                                ({{ number_format(($countDetailsFound->count() / $countDetailsTotal->count()) * 100, 1) }}%)
                                            </p>
                                        </div>
                                        <p class="mb-0"></p>
                                    </div>
