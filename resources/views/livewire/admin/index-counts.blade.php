...
<div>
   ...
   <div class="content-wrapper">
    ...
    <div class=" px-2 mt-10 sm:px-8 flex-grow-1 container-p-y"> 
        ...
        <h4 class=" pt-4"><span class="text-xl ">SGM / Relevamiento de STOCK de materiales </span> </h4>
                        ...
                        <div class="d-flex justify-content-between">
                            <div class="me-1">
                                ...
                                <div class="d-flex align-items-center">
                                    <h4 class="mb-2 me-1 display-6">{{ $countsTotal->count() }}</h4>
                    ...
                    <div class="card-body">
                        <div class="d-flex justify-content-between">
                            <div class="me-1">
                                ...
                                <div class="d-flex align-items-center">
                                    <h4 class="mb-2 me-1 display-6">{{   $countsFound->count() }}</h4>
                                    <p class="text-success mb-2">
                                        ({{ number_format((  $countsFound->count() / $countsTotal->count()) * 100, 1) }}%)
                                    </p>
                                </div>
                                <p class="mb-0"></p>
                            </div>
