                                    ...
                                    <div id="DataTables_Table_0_filter" class="dataTables_filter"><label>
                                            ...
                                            <div class="input-group input-group-floating">
                                                ...
                                                <div class="form-floating">
                                                    ...
                                                    <input wire:model="search" placeholder="Que estas buscando?..."
                                                        type="text" class="form-control rounded-lg" id="search"
                                                        aria-describedby="floatingInputFilledHelp" />

                                                    <label for="floatingInputFilled">Busqueda por ID´s, nombre o
                                                        descripción</label>
                                ...
                                <div class="d-flex justify-content-start justify-content-md-end align-items-baseline">
                                    <div
                                        ...
                                        <div class="dataTables_length mt-0 mt-md-3" id="DataTables_Table_0_length">
                                            <label class="mb-3"><select wire:model="nItems"
                                        ...
                                        <div class="dropdown">
                                            <button type="button"
                                                class="dt-button buttons-collection  btn btn-outline-success  me-3"
                                                data-bs-toggle="dropdown" tabindex="0" aria-haspopup="dialog"
                                                aria-expanded="true">

                                                <span><i class=" mdi mdi-export-variant me-1"></i> <span
                                                        class=" d-none d-sm-inline-block">Export</span></span><span
                                                    class="  px-1 dt-down-arrow">▼</span>
                                            </button>
                                            <div class="dropdown-menu">

                                                <div class="dt-button-collection" aria-modal="true" role="dialog"
                                                    style="top: 54.2344px; left: 612.359px;">
                                                    <div role="menu"> <a
                                                            href="{{ route('admin.pdf.articlesPdf') }}"
                                                            target="_blank"
                                                            class="dt-button buttons-print dropdown-item" tabindex="0"
                                                            aria-controls="DataTables_Table_0" type="button"><span><i
                                                                    class="mdi mdi-printer-outline me-1"></i>Print QR code</span></a>
                                                        {{-- <button
                                                            class="dt-button buttons-csv buttons-html5 dropdown-item"
                                                            tabindex="0" aria-controls="DataTables_Table_0"
                                                            type="button"><span><i
                                                                    class="mdi mdi-file-document-outline me-1"></i>Csv</span></button>
                                                        <button
                                                            class="dt-button buttons-excel buttons-html5 dropdown-item"
                                                            tabindex="0" aria-controls="DataTables_Table_0"
                                                            type="button"><span><i
                                                                    class="mdi mdi-file-excel-outline me-1"></i>Excel</span></button>
                                                        --}}
                                                        <button 
                                                            class="dt-button buttons-pdf buttons-html5 dropdown-item"
                                                            tabindex="0" aria-controls="DataTables_Table_0"
                                                            type="button"><span><i
                                                                    class="mdi mdi-file-pdf-box me-1"></i>Pdf</span></button>
                                                        {{-- <button
                                                            class="dt-button buttons-copy buttons-html5 dropdown-item"
                                                            tabindex="0" aria-controls="DataTables_Table_0"
                                                            type="button"><span><i
                                                                    class="mdi mdi-content-copy me-1"></i>Copy</span></button>
                                                   --}} </div> 
                                                </div>
