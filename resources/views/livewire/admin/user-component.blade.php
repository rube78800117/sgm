<div class="content-wrapper">
    ...
    <div class="container py-2">
        ...
        <x-table-responsive>
            ...
            <div class="px-6 py-4  ">
                <span>busqueda {{ $this->search }}</span>
                <x-jet-input class="w-3/4" wire:model="search" type="text"
                            ...
                            <tr wire:key="{{ $user->email }}">
                                    ...
                                    <div class="flex items-center">
                                        ...
                                        <div class="flex-shrink-0 w-12 h-12">
                                            ...
                                            @else
                                                <!--src="{{ Storage::url('users/def.jpg') }}"-->
                                                <img class="w-full h-full rounded-full object-cover"
                                                    src="{{ asset('storage/' . 'users/def.jpg') }}" alt="" />
                                            @endif
                                        </div>
                                        <div class="ml-3">
                                            <p class="text-gray-900 whitespace-no-wrap">
                                ...
                                <td class="px-5 py-2 border-b border-white bg-white text-sm">
                                    <p class="text-gray-900 whitespace-no-wrap">
                                        ...
                                        @if ($user->line)
                                            ...
                                            <span
                                                class="opacity-80 inline-flex bg-{{ $user->line->color }} text-white rounded-full h-6 px-3 justify-center items-center"
                                                style="width: 160px;">
                                                {{ $user->line->name }}
                                            </span>
                                        @else
                                ...
                                <td class="px-5 py-5 border-b border-gray-200 bg-white text-sm">
                                    <p class="text-gray-900 whitespace-no-wrap text-center ">
                                        @if (count($user->roles))
                                            <span
                                                class="inline-flex bg-green-500 text-white rounded-full h-6 px-3 justify-center items-center">Administrador</span>
                                        @else
                                            No asignado
                                        @endif
                                    </p>
