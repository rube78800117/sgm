...
<!--vISTA DE ORDENES REALIZADAS POR UN USUARIO -->
...
<div>
    ...
    <div class="min-h-screen py-2  justify-center sm:py-1">
        <section class="py-2 mx-auto space-y-2 sm:py-10 sm:pr-2 md:pr-20">
            <div style='width: 100%;' class=" m-12 flex flex-row items-stretch justify-center w-full space-x-12"
                x-data="{tab: 1}">
    ...
    <!--muestra los iconos de clasificacion ne el derecho -->            
                <div class="flex flex-col justify-start w-1/6 space-y-4">
                    ...
                    <a class="px-4 py-2 text-sm"
                        ...
                        @livewire('mycomponents.card', ['color' => "blue-400",'status'=>'Revisi贸n','count'=>"$revision",
