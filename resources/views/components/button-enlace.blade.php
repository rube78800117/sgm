...
<button {{$attributes->merge(['type'=>'button', 'class'=>"text-white bg-gradient-to-r from-$color-400 via-$color-500 to-$color-600 hover:bg-gradient-to-br focus:ring-2 focus:outline-none focus:ring-$color-300 dark:focus:ring-$color-800 shadow-lg shadow-$color-500/50 dark:shadow-lg dark:shadow-$color-800/80 font-medium rounded-lg text-sm px-5 py-2.5 text-center me-2 mb-2"])}}>
