...
<nav x-data="{ open: false }" class="bg-gray-700 border-b-4 border-blue-900 shadow h-19">
 ...
 {{-- buscador por id de insumos o repuestos de menu navegable --}}
            ...
            <div class="hidden sm:flex sm:items-center sm:ml-6">
                ...
                @else
                <a  href="{{ route('login') }}" class="text-sm text-gray-200 "> <i class="fas fa-user mx-1"></i> Iniciar Sesión</a> 
    ...
    <div :class="{'block': open, 'hidden': ! open}" class="hidden sm:hidden">
        ...
        <div class= "py-1 border-t border-gray-200">
            <x-jet-responsive-nav-link  href="{{route('login')}}" :active="request()->routeIs( 'login')">
               <ul class=" text-sm"><i class="fas fa-user mx-2"></i> Iniciar Sesión</ul> 
            </x-jet-responsive-nav-link>
